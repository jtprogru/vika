...
from vika import utils as f
from vika.config import DEFAULT_CALENDAR_EVENTS_NUMBER, PATH_TO_CALENDAR_API_CRED
    ...
    def next(self):
        ...
        events_result = (
            ...
            .list(
                calendarId="primary",
                timeMin=now,
                maxResults=DEFAULT_CALENDAR_EVENTS_NUMBER,
                singleEvents=True,
                orderBy="startTime",
            )
            .execute()
